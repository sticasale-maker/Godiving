...
/* The wander grows: the cave swings (1+GROW)x as far at the exit as at the
...
var perPx = (NU.ROAM1 * 6.283 / NU.L1 + NU.ROAM2 * 6.283 / NU.L2) * (1 + NU.GROW);
var fail = 0;
...
Object.keys(speeds).forEach(function (g) {
  ...
  [330, 560, 900].forEach(function (h) {
    ...
    /* worst case: the exit, where the wander has grown all the way out */
    var slope = (a1 * 6.283 / NU.L1 + a2 * 6.283 / NU.L2) * (1 + NU.GROW);
